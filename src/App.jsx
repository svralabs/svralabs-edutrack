...
import JasaTitipHome from './pages/JasaTitipHome';
...
function ScreenBar() {
  ...
  const navs = [
    ...
    { path: '/jasatitiphome', label: 'JasaTitipHome' },
    { path: '/homeworksearch', label: 'HomeworkSearch' },
    { path: '/myorders', label: 'MyOrders' },
    { path: '/eventcatalog', label: 'EventCatalog' }
  ];
  ...
  return (
    <ErrorBoundary>
      <AuthProvider>
        ...
        <Route path='/jasatitiphome' element={<JasaTitipHome />} />
        <Route path='/homeworksearch' element={<HomeworkSearch />} />
        <Route path='/myorders' element={<MyOrders />} />
        <Route path='/eventcatalog' element={<EventCatalog />} />
                  <Route path="*" element={<Dashboard />} />
                </Routes>
              </div>
            </BrowserRouter>
