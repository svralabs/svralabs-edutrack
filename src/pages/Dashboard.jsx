...
<div className="flex justify-between items-start">
<div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center backdrop-blur-md">
<span className="material-symbols-outlined text-white" onClick={() => navigate("/homework")} data-icon="menu_book">menu_book</span>
</div>
</div>
<div>
...
<span className="material-symbols-outlined" onClick={() => navigate("/")} data-icon="home" style={{ "fontVariationSettings": "'FILL' 1" }}>home</span>
</button>
...
<span className="material-symbols-outlined" onClick={() => navigate("/homework")} data-icon="menu_book">menu_book</span>
</button>
<button className="flex items-center justify-center text-surface-variant p-3 active:scale-90 transition-all duration-200 hover:bg-primary/20">
