    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <footer className="fixed bottom-0 left-0 w-full p-margin-mobile bg-gradient-to-t from-background via-background to-transparent pt-12 z-20">
        <div className="flex flex-col gap-3 max-w-md mx-auto animate-fade-up" style={{ animationDelay: '0.4s' }}>
          {/* Primary Button */}
          <button
            className="w-full py-4 bg-primary-container text-on-primary-container rounded-xl font-heading-md text-heading-md shadow-lg shadow-primary/20 active:scale-95 transition-transform duration-200 flex items-center justify-center gap-2"
          ...
          {/* Secondary Button */}
          <button
            className="w-full py-4 bg-surface border-2 border-outline-variant text-on-surface-variant rounded-xl font-heading-md text-heading-md active:bg-surface-container-low transition-colors duration-200"
